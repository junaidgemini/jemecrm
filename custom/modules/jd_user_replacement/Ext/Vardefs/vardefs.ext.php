...
//ID
$dictionary['jd_user_replacement']['fields']['jd_primary_user_id'] = array(
    'name' => 'jd_primary_user_id',
    'rname' => 'id',
    'vname' => 'LBL_JD_PRIMARY_USER_ID',
    'type' => 'id',
    'table' => 'users',
    'isnull' => 'true',
    'module' => 'Users',
...
//Name
$dictionary['jd_user_replacement']['fields']['jd_primary_user_name'] = array(
    'name' => 'jd_primary_user_name',
    'rname' => 'name',
    'id_name' => 'jd_primary_user_id',
    'vname' => 'LBL_JD_PRIMARY_USER_NAME',
    'type' => 'relate',
    'link' => 'jd_user_replacement_users_link',
    'table' => 'users',
    'isnull' => 'true',
    'module' => 'Users',
    'source' => 'non-db',
...
//Link
$dictionary['jd_user_replacement']['fields']['jd_user_replacement_users_link'] = array(
    'name'  =>  'jd_user_replacement_users_link',
    'type'  =>  'link',
    'relationship'  =>  'jd_user_replacement_users_rel',
    'module' => 'Users',
    'bean_name' => 'User',
    'source' => 'non-db',
    'vname' => 'LBL_JD_USER_REPLACEMENT_USER_LINK',
...
//Relationship
$dictionary["jd_banking_target"]["relationships"]["jd_user_replacement_users_rel"] = array(
    'lhs_module' => 'Users',
    'lhs_table' =>  'users',
    'lhs_key' => 'id',
    'rhs_module' => 'jd_user_replacement',
