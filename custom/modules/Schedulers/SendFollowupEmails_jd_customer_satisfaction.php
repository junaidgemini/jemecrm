...
class SendFollowupEmails_jd_customer_satisfaction {
    public function execute_jd_customer_satisfaction() {
        ...
        $query = "SELECT id, last_email_sent, priority, customer_interaction_status,assigned_user_id,escalation_officer_email, date_entered FROM jd_customer_satisfaction WHERE customer_interaction_status ='Pending' AND DATE_FORMAT(last_email_sent, '%Y-%m-%d %H') = '".$currentTimeForQuery."'  ORDER BY date_entered DESC";
