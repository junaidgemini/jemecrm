    ...
    public function sendNotificationEmail($bean, $event, $arguments){
        ...
        if (!empty($bean->fetched_row) && isset($bean->fetched_row['id'])) {
            ...
            if (!empty($bean->email)){
                ...
                $emailtemplate = $emailtemplate->retrieve("e4687939-8783-a59f-6afd-67c830e01e10");
            ...
            if(!empty($bean->mobile)){
                ...
                $SMStemplate = $SMStemplate->retrieve("43a809f1-e946-0cbf-f465-67d1fb7e0d27");
                ...
                // Example usage:
                $GLOBALS['log']->fatal('Send SMS when jd_purchase ticket is created');
