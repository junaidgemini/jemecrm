...
foreach ($tickets as $ticket) {
    $data[] = [
        ...
        isset($ticket['cc_emails']) && is_array($ticket['cc_emails']) ? implode(', ', $ticket['cc_emails']) : '',
        isset($ticket['reply_cc_emails']) && is_array($ticket['reply_cc_emails']) ? implode(', ', $ticket['reply_cc_emails']) : '',
        isset($ticket['ticket_cc_emails']) && is_array($ticket['ticket_cc_emails']) ? implode(', ', $ticket['ticket_cc_emails']) : '',
        isset($ticket['ticket_bcc_emails']) && is_array($ticket['ticket_bcc_emails']) ? implode(', ', $ticket['ticket_bcc_emails']) : '',
        isset($ticket['fwd_emails']) && is_array($ticket['fwd_emails']) ? implode(', ', $ticket['fwd_emails']) : '',
        isset($ticket['support_email']) && is_array($ticket['support_email']) ? implode(', ', $ticket['support_email']) : '',
        isset($ticket['to_emails']) && is_array($ticket['to_emails']) ? implode(', ', $ticket['to_emails']) : '',
