    ...
    public function sendNotificationEmail($bean, $event, $arguments){
        ...
        if (!empty($bean->fetched_row) && isset($bean->fetched_row['id'])) {
            ...
            if (!empty($bean->email)){
                ...
                $emailtemplate = $emailtemplate->retrieve("13705b46-a59f-49bd-1a2e-67c83304e223");
            ...
            $SMStemplate = $SMStemplate->retrieve("5ebdfae6-df9e-ac54-f2ae-67d1fb50b5e4");
            ...
            $GLOBALS['log']->fatal('Send SMS when Retention ticket is created');
