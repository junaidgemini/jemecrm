    ...
    public function sendNotificationEmail($bean, $event, $arguments){
        ...
        if (!empty($bean->fetched_row) && isset($bean->fetched_row['id'])) {
            ...
            if (!empty($bean->email)){
                ...
                $emailtemplate = $emailtemplate->retrieve("cb5458dc-a536-9904-26c1-67c82df9a750");
            ...
            if(!empty($bean->mobile)){
                ...
                $SMStemplate = $SMStemplate->retrieve("349840b7-00ce-30e3-c1ec-67d1fcfce765");
                ...
                $GLOBALS['log']->fatal('Send SMS when jd_advocacy ticket is created');
