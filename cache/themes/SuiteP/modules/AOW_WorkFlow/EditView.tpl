...
title=''              
>
{if isset($fields.flow_module.value)}
...
title=''              
>
{if isset($fields.run_when.value)}
...
title=''              
>
{if isset($fields.flow_run_on.value)}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_RUN_ON_IMPORT' module='AOW_WorkFlow'}{/capture}
{$label|strip_semicolon}:
...
{if strval($fields.run_on_import.value) == "1" || strval($fields.run_on_import.value) == "yes" || strval($fields.run_on_import.value) == "on"} 
{assign var="checked" value='checked="checked"'}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.run_on_import.name}" value="0"> 
<input type="checkbox" id="{$fields.run_on_import.name}" 
name="{$fields.run_on_import.name}" 
value="1" title='' tabindex="0" {$checked} >
</div>
...
addToValidate('EditView', 'run_on_import', 'bool', false,'{/literal}{sugar_translate label='LBL_RUN_ON_IMPORT' module='AOW_WorkFlow' for_js=true}{literal}' );
